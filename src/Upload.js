...
import './index.css';
import { Button, Pane, Text, Table, Heading, Spinner, Dialog, TextInput, SelectMenu, Position, CornerDialog } from 'evergreen-ui'
                ...
                <div>                      
                    ...
                    <Pane padding='50px' paddingTop={10} justifyContent='center' alignItems='center'>  
                      ...
                      <div className="w3-light-grey">
                        <div className="w3-blue" id="progressBar">{progressBar}</div>
                      </div>
                      <button onClick={() => {window.ipcRenderer.send('test', 'ping')}}>Test Send</button>

                      <Heading size={900}>Scanner Update</Heading>
